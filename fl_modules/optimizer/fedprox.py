...
class FedProxAdam(Optimizer):
    ...
    def __init__(self, params, mu = 0.01, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
...
class FedProxAdamW(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
                 weight_decay=1e-2, amsgrad=False, mu = 0.01):
        if not 0.0 <= lr:
